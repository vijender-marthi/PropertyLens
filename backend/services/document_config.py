...
DOCUMENT_TYPE_CONFIG: dict[str, DocumentTypeConfig] = {
    "mortgage_statement": DocumentTypeConfig(
        ...
        fields=(
            ...
            FieldMapping("monthly_property_tax_escrow", "loan.monthly_property_tax_escrow", "Monthly Property Tax Escrow", "latest_statement", "statement_escrow"),
            FieldMapping("monthly_insurance_escrow", "loan.monthly_insurance_escrow", "Monthly Insurance Escrow", "latest_statement", "statement_escrow"),
            FieldMapping("monthly_mortgage_insurance", "loan.monthly_mortgage_insurance", "Monthly Mortgage Insurance", "latest_statement", "statement_escrow"),
            FieldMapping("monthly_other_escrow", "loan.monthly_other_escrow", "Other Monthly Escrow", "latest_statement", "statement_escrow"),
    ...
    "1098": DocumentTypeConfig(
        ...
        fields=(
            ...
            FieldMapping("mortgage_acquisition_date", "loan.servicer_start_date", "Box 11 Mortgage Acquisition Date", "identity", "loan_timeline"),
    ...
    "closing_statement": DocumentTypeConfig(
        ...
        fields=(
            ...
            FieldMapping("settlement_debit_subtotal", None, "Buyer Debit Subtotal", "verify_only"),
            FieldMapping("settlement_credit_subtotal", None, "Buyer Credit Subtotal", "verify_only"),
            FieldMapping("settlement_due_to_buyer", None, "Due To Buyer", "verify_only"),
            FieldMapping("settlement_debit_total", None, "Buyer Debit Total", "verify_only"),
            FieldMapping("settlement_credit_total", None, "Buyer Credit Total", "verify_only"),
            FieldMapping("settlement_purchase_price_adjustment", None, "Settlement Adjustment", "verify_only"),
