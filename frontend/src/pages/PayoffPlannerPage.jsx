...
function ScenarioWidget({ open, onToggle, scenarios, activeScenario, activeMatches, busy, onSave, onUpdate, onApply, onDelete, onCompare, compareOpen, compareColumns, onExportCompare, onExport, canExport }) {
  ...
  return (
    <div className="relative">
      ...
      {open ? (
        <div className={`absolute left-0 z-30 mt-2 max-w-[calc(100vw-2rem)] rounded-xl border border-gray-200 bg-white p-4 shadow-xl transition-[width] dark:border-gray-700 dark:bg-gray-800 sm:left-auto sm:right-0 ${showCompare ? 'w-[44rem]' : 'w-[26rem]'}`}>
