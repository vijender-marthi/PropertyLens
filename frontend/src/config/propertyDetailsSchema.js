...
export const propertyIdentitySections = [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'cash_to_close', label: 'Cash to close', formatter: 'currency' },
      { id: 'total_due_from_borrower', label: 'Total due from borrower', formatter: 'currency' },
      { id: 'settlement_debit_total', label: 'Settlement debit total', formatter: 'currency' },
      { id: 'settlement_credit_total', label: 'Settlement credit total', formatter: 'currency' },
      { id: 'market_value', label: 'Market Price', formatter: 'currency' },
